...
class test {
    ...
    String[][] pile = new String[nbLigne*nbColonne][3];
    int i_pile=0;
    ...
    void run() {
        ...
        while(true){
            ...
            """);
            nav.endPage();
            System.out.print(pile[0][0]+" "+pile[1][0]);
        }
    }
    ...
    void modif_cellule(String contenu, String cellule){
                ...
                pile[i_pile][1] = Integer.toString(ligne);
    ...
    //Essaie d'une fonction annuler : stocker les valeurs précedentes dans une pile avant de modifier la cellule (cf procédure ci-dessus) dans une pile pour les remplacer si besoin avec cette fonction
    void annuler(){
            String valeur = pile[i_pile-1][0];
            String ligne = pile[i_pile-1][1];
            String colonne = pile[i_pile-1][2];
            tableur[Integer.parseInt(ligne)][Integer.parseInt(colonne)] = valeur;
            i_pile--;
    }
    ...
    //Sépare les coordonnées de la ligne et la colonne
